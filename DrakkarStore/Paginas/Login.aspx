<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="DrakkarStore.Paginas.Login" %>
...
<body class="bodycontacto">
    ...
    <div class="bodylogin">
        ...
        <table align="center" class="formlogin">
            <tr>
                <td colspan="2" text-align="center"><strong>INICIAR SESION</strong></td>
            </tr>
            <tr>
                <td class="tduserpw"><b>Usuario:</b></td>
                <td>
                    <asp:TextBox ID="TxtUsuario" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="tduserpw"><b>Contraseña:</b></td>
                <td>
            ...
            <tr>
                <td >&nbsp;</td>
                <td>
                    <asp:Button class="boton" ID="BtnLogin" runat="server" Text="Iniciar Sesion" OnClick="BtnLogin_Click" />
                    <a class="boton" href="Registro.aspx">Registrarse</a>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <a  id="olvpw" href="#">¿Olvidaste Tu Contraseña?</a>
                </td>
            </tr>
        </table>
